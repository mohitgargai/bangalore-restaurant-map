...
export const INITIAL_RESTAURANTS: Restaurant[] = [
  // 1. Vidyarthi Bhavan (Basavanagudi)
  {
    ...
    curatorNote: 'Expect a short wait on weekends, but the iconic waiter stack of 20 dosa plates is worth every minute.',
    isVegetarian: true,
    verified: true,
  },
  ...
  // 3. The Rameshwaram Cafe (Indiranagar)
  {
    ...
    curatorNote: 'Open until 1 AM for late night ghee podi cravings. The aroma of roasted ghee is unmistakable.',
    isVegetarian: true,
    verified: true,
  },
  // 4. Toit Brewpub (Indiranagar)
  {
    id: 'toit-brewpub',
    name: 'Toit Brewpub',
    slug: 'toit-brewpub',
    ...
    curatorNote: 'Colonial Toit IPA paired with the garlic sourdough loaf is unmatched.',
    isVegetarian: false,
    verified: true,
  },
  // 5. Mavalli Tiffin Room (MTR Lalbagh)
  {
    id: 'mtr-lalbagh',
  ...
  // 7. Windmills Craftworks (Whitefield)
  {
  ...
  // 10. Brahmins\' Coffee Bar (Shankarapuram)
  {
  ...
  // 11. Pecos Classic (Rest House Road)
  {
  ...
  // 22. Bengaluru Oota Company (Cambridge Layout)
  {
    ...
    curatorNote: 'Authentic home-cooked coastal Karnataka cuisine by prior reservation.',
    isVegetarian: false,
    verified: true,
  },
  ...
  // 26. Daily Sushi (Indiranagar)
  {
    ...
    curatorNote: 'Fresh fish flown in regularly with perfectly seasoned sushi rice.',
    isVegetarian: false,
    verified: true,
  },
  // 27. Sriracha & Sanchez (UB City)
  {
    ...
    timings: '12:00 PM – 11:30 PM',
    curatorNote: 'Ask for the alfresco terrace table overlooking UB City.',
    isVegetarian: false,
    verified: true,
  },
  // 28. Hari Super Sandwich (Jayanagar)
  {
    ...
    curatorNote: 'The Chocolate Cheese sandwich with chocolate sauce drizzle is a local cult favorite.',
    isVegetarian: true,
    verified: true,
  },
  // 29. Brik Oven (Church Street)
  {
  ...
  // 30. Koshy\'s Parade Cafe (St. Mark\'s Road)
  {
  ...
  // 31. Corner House Ice Cream (Residency Road)
  {
