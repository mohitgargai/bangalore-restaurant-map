...
export const INITIAL_RESTAURANTS: Restaurant[] = [
  ...
  // 21. The Fatty Bao (Indiranagar)
  {
    ...
    name: 'The Fatty Bao (Indiranagar)',
    ...
    branches: [
      {
        id: 'the-fatty-bao-lavelle-road',
        name: 'Lavelle Road',
        neighborhood: 'Lavelle Road',
        address: '1st Floor, 25/4, Lavelle Road, Opposite Harley Davidson, Ashok Nagar, Bengaluru, Karnataka 560001',
        lat: 12.971240,
        lng: 77.600180,
        googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=The+Fatty+Bao+25%2F4+Lavelle+Road+Ashok+Nagar+Bengaluru',
      },
    ],
  },
  // 22. The Fatty Bao (Lavelle Road)
  {
    id: 'the-fatty-bao-lavelle-road',
    name: 'The Fatty Bao (Lavelle Road)',
    slug: 'the-fatty-bao-lavelle-road',
    tagline: 'Chic CBD Asian gastropub with artisan dim sum & baos',
    description: 'The central Bangalore outpost of The Fatty Bao on Lavelle Road, offering a vibrant izakaya-style ambiance, sushi rolls, and signature craft cocktails.',
    category: 'Pan-Asian & Japanese',
    neighborhood: 'Lavelle Road',
    address: '1st Floor, 25/4, Lavelle Road, Opposite Harley Davidson, Ashok Nagar, Bengaluru, Karnataka 560001',
    lat: 12.971240,
    ...
    priceLevel: '₹₹₹',
    priceForTwo: '₹1,600',
    mustTry: ['Crispy Duck Bao', 'Truffle & Edamame Dumpling', 'Salmon Carpaccio', 'Miso Smoked Salmon'],
    vibeTags: ['Romantic', 'Cocktail Program'],
    imageUrl: 'https://images.unsplash.com/photo-1541544741938-0af808871cc0?auto=format&fit=crop&w=1000&q=80',
    googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=The+Fatty+Bao+25%2F4+Lavelle+Road+Ashok+Nagar+Bengaluru',
    timings: '12:00 PM – 11:00 PM',
    curatorNote: 'Convenient central location on Lavelle Road. Try the crispy duck bao with hoisin glaze.',
    isVegetarian: false,
    verified: true,
    branches: [
      {
