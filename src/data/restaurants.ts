...
export const INITIAL_RESTAURANTS: Restaurant[] = [
  ...
  // 21. The Pizza Bakery (Indiranagar)
  {
    ...
    branches: [
      ...
      {
        id: 'the-pizza-bakery-koramangala',
        name: 'Koramangala (5th Block)',
        neighborhood: 'Koramangala',
        address: '35, 4th B Cross Rd, 5th Block, Koramangala, Bengaluru, Karnataka 560095',
        lat: 12.932848,
        lng: 77.630000,
        googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=The+Pizza+Bakery+5th+Block+Koramangala+Bengaluru',
      },
      {
        id: 'the-pizza-bakery-bellandur',
        name: 'Bellandur (The Bay, EcoWorld)',
        neighborhood: 'Whitefield',
        address: 'The Bay, RMZ Ecoworld, Outer Ring Road, Bellandur, Bengaluru, Karnataka 560103',
        lat: 12.929806,
        lng: 77.684629,
        googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=The+Pizza+Bakery+The+Bay+RMZ+Ecoworld+Bellandur+Bengaluru',
      },
    ],
  },
  // 22. The Pizza Bakery (Church Street)
  {
    id: 'the-pizza-bakery-church-street',
  ...
  // 28. Phobidden Fruit (Indiranagar)
  {
  ...
  // 30. Anupam\'s Coast II Coast (Brunton Road)
  {
  ...
  // 32. Amadora Gourmet Ice Cream (Indiranagar)
  {
  ...
  // 33. 154 Breakfast Club (Koramangala)
  {
    ...
    category: 'Specialty Coffee & Cafe',
    neighborhood: 'Koramangala',
    address: '154, 8th Main Rd, 3rd Block, Koramangala, Bengaluru, Karnataka 560034',
    lat: 12.933281,
    lng: 77.627074,
    priceLevel: '₹₹',
    priceForTwo: '₹800',
  ...
  // 39. Windmills Craftworks (Whitefield)
  {
  ...
  // 44. Chinita Real Mexican Food (Indiranagar)
  {
  ...
  // 45. Maravanthe Coastal Diner (Indiranagar)
  {
  ...
  // 46. Ranganna Military Hotel (Jayanagar)
  {
  ...
  // 47. Anju’s Cafe at Ranga Shankara (JP Nagar)
  {
  ...
  // 51. Bengaluru Oota Company (Halasuru)
  {
