...
export const CURATED_STORIES: FoodStory[] = [
  ...
  },
  {
    ...
    restaurantIds: ['toit-brewpub', 'windmills-craftworks', 'arbor-brewing-company', 'byg-brewski-hennur', 'geist-brewing-taproom'],
    author: 'Beer Guild',
  ...
  },
  {
    ...
    restaurantIds: ['araku-coffee', 'paper-and-pie-indiranagar', 'blue-tokai-koramangala', 'third-wave-coffee-hsr'],
