  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-[1200] p-2.5 sm:p-4">
      <div className="pointer-events-auto mx-auto max-w-6xl">
        ...
        <div className="rounded-2xl sm:rounded-full border border-zinc-200/90 bg-white/95 px-3.5 py-2 sm:py-2.5 shadow-xl shadow-zinc-950/5 backdrop-blur-xl transition-all">
          <div className="flex flex-col gap-2.5 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-2.5 flex-1 min-w-0">
              ...
              <div className="relative flex-1 min-w-0 max-w-md">
                ...
                <input
                  ...
                  placeholder="Search dish (Dosa, Pour-over, IPA) or spot…"
                ...
                {searchQuery ? (
                  ...
                  <kbd className="hidden lg:inline-block absolute right-2.5 top-1/2 -translate-y-1/2 rounded border border-zinc-200 bg-white px-1 py-0.2 text-[9px] font-semibold text-zinc-400">
                    ⌘K
                  </kbd>
                )}
              </div>
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar pt-1 md:pt-0 border-t md:border-t-0 border-zinc-100 shrink-0">
              {/* Modern Neighborhood Selector */}
              <div className="relative shrink-0">
                <select
                  value={selectedNeighborhood}
                  onChange={(e) => onSelectNeighborhood(e.target.value as any)}
                  className="appearance-none rounded-full border border-zinc-200/90 bg-zinc-50/90 pl-3 pr-7 py-1.5 text-xs font-semibold text-zinc-800 hover:bg-zinc-100 transition-colors focus:outline-none cursor-pointer"
                >
                  <option value="All">📍 All Hoods</option>
              ...
              <div className="relative shrink-0">
                <select
                  ...
                  className="appearance-none rounded-full border border-zinc-200/90 bg-zinc-50/90 pl-3 pr-7 py-1.5 text-xs font-semibold text-zinc-800 hover:bg-zinc-100 transition-colors focus:outline-none cursor-pointer"
                >
                  <option value="All">✨ All Cravings ({totalFilteredCount})</option>
              ...
              <button
                ...
                className={`flex items-center gap-1 rounded-full px-2.5 py-1.5 text-xs font-semibold transition-all shrink-0 ${
                  vegOnly
                    ? 'bg-emerald-50 text-emerald-800 border border-emerald-300 shadow-xs'
                    : 'border border-zinc-200/90 bg-zinc-50/90 text-zinc-600 hover:bg-zinc-100'
                }`}
              ...
              {/* View Switcher */}
              <div className="flex rounded-full border border-zinc-200/90 bg-zinc-100/90 p-0.5 text-xs shrink-0">
                <button
