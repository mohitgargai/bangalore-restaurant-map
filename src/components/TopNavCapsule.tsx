  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-0 z-[1200] p-3 sm:p-4">
      <div className="pointer-events-auto mx-auto max-w-6xl">
        ...
        <div className="flex flex-col gap-2 rounded-3xl border border-zinc-200/90 bg-white/95 p-2.5 shadow-xl shadow-zinc-950/5 backdrop-blur-xl transition-all sm:flex-row sm:items-center sm:justify-between sm:p-3">
          {/* Brand + Omni Search */}
          <div className="flex items-center gap-2.5 flex-1 min-w-0">
            {/* Brand Monogram */}
            <div className="flex items-center gap-2 shrink-0">
              <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-zinc-950 text-white font-serif font-black text-base shadow-sm">
                B
              </div>
              <div className="hidden md:block">
                ...
                <p className="text-[10.5px] text-zinc-400 font-medium">Curated Index</p>
              </div>
            </div>
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                placeholder="Search dish (Dosa, Coffee, IPA, Tacos) or place…"
                className="w-full rounded-2xl border border-zinc-200/90 bg-zinc-50/80 py-2 pl-9 pr-8 text-xs sm:text-sm text-zinc-900 placeholder-zinc-400 transition-colors focus:border-zinc-900 focus:bg-white focus:outline-none focus:ring-1 focus:ring-zinc-900"
              />
              {searchQuery ? (
                <button
          ...
          {/* Controls: Area dropdown, Veg filter, Saved, View Switcher & Submit */}
        ...
        {/* Floating Category Craving Ribbon */}
        <div className="mt-2 flex items-center justify-center gap-1.5 overflow-x-auto no-scrollbar py-0.5">
          <div className="flex items-center gap-1.5 rounded-full border border-zinc-200/80 bg-white/90 p-1 shadow-md backdrop-blur-md">
            <button
